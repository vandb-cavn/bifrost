...
func (provider *BraveProvider) Search(_ *schemas.BifrostContext, _ schemas.Key, _ *schemas.BifrostSearchRequest) (*schemas.BifrostSearchResponse, *schemas.BifrostError) {
