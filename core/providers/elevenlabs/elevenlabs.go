...
// Search is not supported by the Elevenlabs provider.
func (provider *ElevenlabsProvider) Search(ctx *schemas.BifrostContext, key schemas.Key, request *schemas.BifrostSearchRequest) (*schemas.BifrostSearchResponse, *schemas.BifrostError) {
