...
<Frame>
  <img src="/media/user-provisioning/google-oauth-consent.png" alt="Google OAuth consent screen configuration" />
</Frame>
...
<Frame>
  <img src="/media/user-provisioning/google-oauth-client-create.png" alt="Creating a Google OAuth Web Application Client ID" />
</Frame>
...
<Frame>
  <img src="/media/user-provisioning/google-service-account-create.png" alt="Creating a Google service account" />
</Frame>
...
<Frame>
  <img src="/media/user-provisioning/google-dwd.png" alt="Google Workspace Domain-Wide Delegation configuration" />
</Frame>
...
<Frame>
  <img src="/media/user-provisioning/google-bifrost-config.png" alt="Bifrost Google Workspace configuration form" />
</Frame>
...
| `clientSecret` | No | Client Secret — required for token revocation and for confidential server-side flows. |
| `audience` | No | Expected JWT audience. Defaults to `clientId`. |
| `adminEmail` | Yes if provisioning | Workspace admin to impersonate via domain-wide delegation. Required when any service-account field is set. |
